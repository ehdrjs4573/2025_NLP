...
2) 직무 및 기업 정보 수집
- CareerNet OpenAPI, NICE OpenAPI를 활용하여 직무 목록 및 상세 정보 수집
...
3) 자기소개서 입력
	•	실제 자기소개서 전문 입력 가능
	•	입력 텍스트를 분석 대상으로 사용
![alt text](<스크린샷 2025-12-12 오후 11.55.18.png>)
...
사용자는 분석 결과를 다음 항목으로 확인할 수 있습니다.
	...
	•	반복 표현 분석 결과
	•	STAR 구조 분석 결과
![alt text](<스크린샷 2025-12-12 오후 11.55.54.png>)
![alt text](<스크린샷 2025-12-12 오후 11.56.09.png>)
![alt text](<스크린샷 2025-12-12 오후 11.56.21.png>)
![alt text](<스크린샷 2025-12-12 오후 11.56.26.png>)
